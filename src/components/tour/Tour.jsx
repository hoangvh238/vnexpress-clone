                    ...
                    <div className="left">
                        <div className="item">
                            ...
                            <div className="content">
                                <h3 className="title">
                                    <a href="/">
                                        Vợ chồng Việt cắm trại dọc bờ tây nước
                                        Mỹ
                                    </a>
                                </h3>
                                <p className="desc">
                                    <a href="/">
                                        Khánh Vân cùng chồng tận hưởng thiên
                                        nhiên kỳ thú qua những chuyến cắm trại ở
                                        chín bang bờ Tây nước Mỹ.
                                    </a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="center">
                        <div className="item">
                            ...
                            <div className="content">
                                <h3 className="title">
                                    <a href="/">
                                        Những bức ảnh du lịch khó quên
                                    </a>
                                </h3>
                            </div>
                        </div>
                        <div className="item">
                            ...
                            <div className="content">
                                <h3 className="title">
                                    <a href="/">
                                        Tiệm phở của đầu bếp Việt lên báo
                                        Singapore
                                    </a>
                                </h3>
                            </div>
                    ...
                    <div className="right">
                        <div className="item">
                            <div className="content">
                                <h3 className="title">
                                    <a href="/">
                                        Moscow là thành phố thuộc bang nào ở Mỹ?
                                    </a>
                                </h3>
                            </div>
                            <div className="img">
                        ...
                        <div className="item">
                            <div className="content">
                                <h3 className="title">
                                    <a href="/">
                                        Giá euro giảm, du khách Việt ở châu Âu
                                        được lợi
                                    </a>
                                </h3>
                            </div>
                        ...
                        <div className="item">
                            <div className="content">
                                <h3 className="title">
                                    <a href="/">
                                        10 điểm đến trong nước được yêu thích
                                        nhất hè 2022
                                    </a>
                                </h3>
                            </div>
                        ...
                        <div className="item">
                            <div className="content">
                                <h3 className="title">
                                    <a href="/">
                                        Làm nhân viên khách sạn ở châu Âu dễ
                                        chưa từng thấy
                                    </a>
                                </h3>
                            </div>
